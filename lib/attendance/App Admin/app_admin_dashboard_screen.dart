...
class AppAdminDashboardScreen extends StatefulWidget {
  ...
  @override
  State<AppAdminDashboardScreen> createState() =>
      _AppAdminDashboardScreenState();
}

class _AppAdminDashboardScreenState extends State<AppAdminDashboardScreen>
    ...
    return MultiProvider(
      providers: [
        ChangeNotifierProvider(
          create: (_) =>
              AttendanceProvider(empId: widget.employeeId.toString()),
        ),
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          title: Text(
            selectedIndex < titles.length ? titles[selectedIndex] : '',
