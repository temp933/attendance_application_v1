...
// // // // // ─────────────────────────────────────────────────────────────────────────────
// // // // //  AttendanceHistoryScreen  — simple in/out view
// // // // //  Uses GET /attendance/history?limit=30&offset=0
// // // // // ─────────────────────────────────────────────────────────────────────────────
...
// // // //     try {
// // // //       final res = await ApiClient.get('/attendance/history?limit=30&offset=0');
// // // //       if (!mounted) return;
...
// // // //         setState(() { _loading = false; _error = body['message'] ?? 'Unknown error'; });
// // // //         return;
// // // //       }

// // // //       setState(() {
// // // //         _records = (body['records'] as List).cast<Map<String, dynamic>>();
// // // //         _loading = false;
// // // //       });
// // // //     } catch (e) {
...
// // // //             Text(_error!, style: const TextStyle(color: _textMid, fontSize: 13), textAlign: TextAlign.center),
...
// // // //             const Text('No attendance records yet.', style: TextStyle(color: _textMid, fontSize: 14)),
// // // //           ],
// // // //         ),
// // // //       );
// // // //     }
...
// // // //   @override
// // // //   Widget build(BuildContext context) {
// // // //     final workDate   = record['work_date']      as String? ?? '';
...
// // // //     DateTime? day;
// // // //     try { day = DateTime.parse(workDate); } catch (_) {}
...
// // // //     // Accent colour: active=green, late=orange, completed=primary
// // // //     final Color accent = isActive ? _green : isLate ? _orange : _primary;
...
// // // //                       Text(
// // // //                         dayLabel,
// // // //                         style: TextStyle(fontSize: 10, fontWeight: FontWeight.w700, color: accent.withValues(alpha: 0.8)),
// // // //                       ),
// // // //                       const SizedBox(height: 1),
// // // //                       Text(
// // // //                         dateLabel,
// // // //                         textAlign: TextAlign.center,
// // // //                         style: TextStyle(fontSize: 13, fontWeight: FontWeight.w800, color: accent, height: 1.1),
// // // //                       ),
// // // //                       if (isToday) ...[
...
// // // //                           child: const Text('Today', style: TextStyle(fontSize: 7, color: Colors.white, fontWeight: FontWeight.w700)),
// // // //                         ),
// // // //                       ],
// // // //                     ],
// // // //                   ),
...
// // // //                             color: _green,
// // // //                           ),
// // // //                           Container(width: 1, height: 36, color: const Color(0xFFE2E8F0), margin: const EdgeInsets.symmetric(horizontal: 10)),
// // // //                           _timeBlock(
...
// // // //                               mainAxisSize: MainAxisSize.min,
// // // //                               children: [
// // // //                                 const Icon(Icons.schedule_rounded, size: 12, color: _orange),
...
// // // //             Text(label, style: const TextStyle(fontSize: 10, color: _textLight, fontWeight: FontWeight.w600)),
// // // //           ],
// // // //         ),
// // // //         const SizedBox(height: 3),
// // // //         Text(
...
// // // // ─────────────────────────────────────────────────────────────────────────────
// // // //  AttendanceHistoryScreen  — calendar view with day detail on tap
// // // //  Uses GET /attendance/history?limit=100&offset=0
// // // // ─────────────────────────────────────────────────────────────────────────────
...
// // //   /// All records grouped by work_date ("YYYY-MM-DD")
...
// // //     });
// // //     try {
// // //       final res = await ApiClient.get('/attendance/history?limit=100&offset=0');
// // //       if (!mounted) return;
// // //       if (res.statusCode != 200) {
// // //         setState(() {
// // //           _loading = false;
...
// // //       final hasLate =
// // //           recs != null && recs.any((r) => (r['is_late'] as num?)?.toInt() == 1);
// // //       final hasData = recs != null && recs.isNotEmpty;

// // //       final Color dotColor = hasLate ? _orange : _green;
// // //       final Color accentColor = today ? _primary : _primary;
...
// // // // ─────────────────────────────────────────────────────────────────────────────
// // // //  Card widget (unchanged from original)
// // // // ─────────────────────────────────────────────────────────────────────────────
...
// //     // Build a flat list of 7-column rows manually so each row has a fixed height
// //     const double cellH = 44.0;
...
// // ─────────────────────────────────────────────────────────────────────────────
// //  AttendanceHistoryScreen  — calendar view
// //
// //  Each day cell shows tiny labels (stacked, up to 3):
// //    • H (red)    — public holiday on that date
// //    • L (purple) — approved/pending leave on that date
// //    • C (teal)   — comp-off earned on that date
// //    • green dot  — attended (on-time)
// //    • orange dot — attended (late)
// //
// //  APIs used:
// //    GET /attendance/history?limit=100&offset=0
// //    GET /holidays?year=YYYY
// //    GET /leave/my-leaves?year=YYYY
// //    GET /comp-off
// // ─────────────────────────────────────────────────────────────────────────────
...
//         ApiClient.get('/attendance/history?limit=100&offset=0'),
