...
// const requireAppAdmin = require("./middleware/app_admin_auth"); // adjust path to match your project
...
app.post("/api/auth/forgot-password/send-otp", async (req, res) => {
  try {
    ...
    const [users] = await db.query(
      `SELECT lm.login_id, lm.username, lm.contact_number, lm.role_id, lm.tenant_id,
